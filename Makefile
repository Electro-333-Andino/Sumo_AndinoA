...
tests/test_gamepad: tests/test_gamepad.cpp GamepadParser.cpp GamepadMixer.cpp CommandParser.cpp GamepadFilter.h GamepadInputState.h tests/stubs/Arduino.h
	$(CXX) $(CXXFLAGS) $^ -o $@
